...
//    }
    ...
    func viewLoadSetup(){
        ...
        Play.setTitleColor(Theme.mainFontColor, for: UIControlState.normal)
        Settings.setTitleColor(Theme.mainFontColor, for: UIControlState.normal)
        Exit.setTitleColor(Theme.mainFontColor, for: UIControlState.normal)
